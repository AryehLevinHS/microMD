...
import {
  ...
  NAV_MEDINFO_ALLERGIES,NAV_MEDINFO_REFILLS,
...
export const Routes = () => {
    ...
    //=============================================================================
    const HomeNavigator = () => {
      return (<HomeStack InitialRouteName={NAV_HOME}>
    ...
    const BottomNavigator = () => {
      return (<HomeTab InitialRouteName={NAV_HOME}>
    ...
    const PatientNavigator = () => {
      return (<PatientDrawer InitialRouteName={NAV_PATIENT_PROVIDERS}>
    ...
    //=============================================================================
    const MailNavigator = () => {
      return (<MailDrawer InitialRouteName={NAV_MAIL_INBOX}>
    ...
    const PracticeNavigator = () => {
      return (<PracticeDrawer InitialRouteName={NAV_PRACTICE_NEWS}>
  ...
  return (
   ...
   return (
        <MainStack.Navigator>
            {authenticated ?
            //  <LoginStack.Screen name={NAV_USER_LOGIN}    component={LoginScreen} />
              // <MainStack.Screen name={NAV_HOME}              component={HomeNavigator} />
              <MainStack.Screen name={NAV_USER_LOGIN}        component={LoginNavigator} />
            :
             <HomeTab.Screen name={NAV_HOME}              component={HomeScreen} />
              //  <MainStack.Screen name={NAV_HOME}        component={HomeNavigator} />
             }
